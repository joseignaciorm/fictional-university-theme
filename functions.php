...
/**
 * CUSTOM LIKE REST API ROUTE: 
 */
require get_theme_file_path( '/inc/like-route.php' );


/**
 * CUSTOM SEARCH REST API ROUTE: 
 */
    ...
    function university_files() {
        ...
        if (strstr($_SERVER['SERVER_NAME'], 'fictional-university.test')) {
            wp_enqueue_script('main-university-js', 'http://localhost:3000/bundled.js', NULL, '1.0', true); # This only work in our local machine. Not on a production server.
                ...
                wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.b79e9a11bf0418f5f74c.js'), NULL, '1.0', true);
                wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.b79e9a11bf0418f5f74c.css'));
                wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.b79e9a11bf0418f5f74c.js'), NULL, '1.0', true);
                wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.b79e9a11bf0418f5f74c.css'));
                wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.b79e9a11bf0418f5f74c.js'), NULL, '1.0', true);
                wp_enqueue_style('our-main-styles', get_theme_file_uri('/bundled-assets/styles.b79e9a11bf0418f5f74c.css'));
...
/**
 *  ALL IN ONE WP MIGRATION FILTER PLUGIN TO IGNORE FILES BEFORE EXPORT TO
 */
add_filter('ai1wm_exclude_content_from_export', 'ignoreCertainFiles');

if (!function_exists('ignoreCertainFiles')) {
